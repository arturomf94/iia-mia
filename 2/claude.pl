% Welcome to rules.pl
% (~billw/public_html/cs9414/notes/kr/rules/rules.pl, in full).
% You can also find it as
% http://www.cse.unsw.edu.au/~billw/cs9414/notes/kr/rules/rules.pro
%
...
% Modified for SWI Prolog by Bill Wilson, December 2005.
%
%    iF is so spelled because "if" was predefined in iProlog.
%
% This code is fairly heavily commmented because it is intended
% for novice Prolog programmers. The use of the full lines of %%%%%%%
% is not liked by everyone, and is retained here for historical
% reasons.
...
%    add it to working memory if it is not already there.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
